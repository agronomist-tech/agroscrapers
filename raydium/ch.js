        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prepareCHTables(conn)];
                case 1:
                    _a.sent();
...
function prepareCHTables(conn) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, conn.query("CREATE TABLE IF NOT EXISTS lpools\n                            (\n                                address String,\n                                base String,\n                                quote String,\n                                liquidity String,\n                                date DateTime      \n                            ) \n                            ENGINE=MergeTree()\n                            ORDER BY date\n    ").toPromise()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, conn.query("CREATE TABLE IF NOT EXISTS farms\n                            (\n                                address String,\n                                rewards Array(String),\n                                amount String,\n                                date DateTime\n                            ) \n                            ENGINE=MergeTree()\n                            ORDER BY date\n    ").toPromise()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
